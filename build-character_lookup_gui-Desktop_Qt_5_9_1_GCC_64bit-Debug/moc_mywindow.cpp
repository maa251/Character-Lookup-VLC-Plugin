...
#include "../character_lookup_gui/mywindow.h"
...
QT_MOC_LITERAL(4, 45, 12), // "tmdbFinished"
QT_MOC_LITERAL(5, 58, 16), // "castListFinished"
QT_MOC_LITERAL(6, 75, 12) // "wikiFinished"

    },
    "MyWindow\0httpFinished\0\0on_pushButton_clicked\0"
    "tmdbFinished\0castListFinished\0"
    "wikiFinished"
};
...
void MyWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->tmdbFinished(); break;
        case 3: _t->castListFinished(); break;
        case 4: _t->wikiFinished(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
